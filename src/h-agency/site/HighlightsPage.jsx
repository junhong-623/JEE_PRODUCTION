...
export default function HighlightsPage() {
  ...
  const { honorTalents, rankingTalents } = useHAgencyData()
  const zh = lang === 'zh'
  return (
    <>
      ...
      <section className="bg-[#1a1116] py-20 sm:py-28"><div className="mx-auto max-w-7xl px-6"><SectionHeader dark title={t.honorsTitle} sub={t.honorsSub} intro={t.honorsIntro} /><HonorGrid talents={honorTalents} /></div></section>
      <section className="bg-[#f8f3f2] py-20 sm:py-32"><div className="mx-auto max-w-7xl px-6"><SectionHeader title={t.rankingTitle} sub={t.rankingSub} intro={t.rankingIntro} /><RankingGrid talents={rankingTalents} /></div></section>
    </>
  )
}
