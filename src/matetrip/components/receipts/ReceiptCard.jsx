...
export default function ReceiptCard({ receipt, people, currency, readOnly, onEdit, onDelete }) {
  const { tr, t } = useLang();
  ...
  return (
    <div className={`receipt-card card ${readOnly ? "" : "card-hover"}`} onClick={readOnly ? undefined : onEdit}>
