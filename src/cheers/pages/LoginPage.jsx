    ...
    <div className="min-h-[70vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="font-serif text-3xl text-cheers-dark-brown">{t('auth.login')}</h1>
        </div>
        <div className="card p-6 space-y-4">
          ...
          <p className="text-center text-sm text-cheers-brown/60">
            {t('auth.noAccount')}{' '}
            <Link to="/register" className="text-cheers-brown font-medium hover:underline">{t('auth.registerHere')}</Link>
          </p>
        </div>
      </div>
    </div>
